...
- **Merging**: two cards' tier values add together, capped at 4 (Orange).
  E.g. Blue+Blue=Green, Blue+Green=Red, Green+Green=Blue+Red=Orange. Done by
  dragging one of your board cards and dropping it onto another (mouse or
  touch, via Pointer Events) — no mode button needed.
