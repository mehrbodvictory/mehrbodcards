...
Version 2.2 adds the Collection Book chooser for Cards and Themes. Patch notes are displayed in-game under Patch Notes.
...
- Added a fully animated **100% Collector** theme — a cosmic collector vault with holographic card edges, orbital rings, aurora lighting, constellation particles, and a 100% completion treatment. It is unlocked only when every currently-defined card is collected, so any newly added card automatically locks it again until collected.
