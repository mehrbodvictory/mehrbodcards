...
const PATCH_NOTES = [
  {
    version: '2.1',
    notes: [
      "Fixed how Blue defense/replenishment unlocks: it's now a permanent flag from the moment you first merge two Blues into anything higher, instead of being re-checked live against what's currently on the board (which could flicker back off if that merged card later died).",
      "Moved the Mehrbod Bux balance out of scattered menu text and into a single fixed counter in the top-right corner, Fortnite V-Bucks style. It shows on every menu screen, hides during an actual match, and tapping it jumps straight to the Shop.",
      "Wager matches moved out of the Shop: Practice vs Bot and Host Match now each ask Normal Match vs Wager Match up front. The Shop is now just Card Packs and Cosmetics.",
      "New: the Mr Money theme — a purchasable Shop item (1000 Bux, not quest-earned) with a green palette and money bills raining down the screen.",
      "New: a Cosmetics section in the Shop — Holographic and Gold card sleeves (glowing animated outlines around every card), and a Confetti+ effect for a bigger, longer victory celebration. All purchases are permanent and apply instantly.",
    ],
  },
  {
    version: '2.0',
