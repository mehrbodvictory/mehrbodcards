...
// Every render() call rebuilds the DOM for boards/cards/spells-chips from
...
// (freshly placed, or fused into existence).
const _seenCardIds = {};
...
// ---- NEW FEATURE: colorblind-friendly tier glyphs --------------------------
// Tier is currently conveyed only by card background color (blue/green/red/
...
const ABILITY_SHORT = {
  ...
  red_onattack_splash1: 'Attacks splash 1 dmg',
  orange_onplay_execute: "Play: execute foe's weakest",
